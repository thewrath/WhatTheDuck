 ...
 */
#define debugGL(texte)              _debugGL(__FILE__, __LINE__,texte,false)
#define debugGLFatal(texte)         _debugGL(__FILE__, __LINE__,texte,true)

int _debugGL(const char *file, int line, const char* texte, bool fatal=false);
 ...
 */
template<typename T> static void list_remove(std::vector<T>& vect, int index)
{
